...
| 2026-07-17 | Working tree after `FIND-0152` resolution | Windows PowerShell 5.1 | `powershell -NoProfile -ExecutionPolicy Bypass -File tests/protocol.tests.ps1` | Passing in 535.1 seconds; all discovered suites, 35 quick-adoption scenarios including `TEST-0107`, and `TEST-0105`/`TEST-0106` passed |
