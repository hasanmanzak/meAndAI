...
| 2026-07-26 | Candidate before [FIND-0308](README.md#find-0308) | Windows PowerShell 5.1 | `tests/protocol.tests.ps1` | Failed after 2,016.9 seconds only at [TEST-0159](../FEAT-0039-v0130-test-runtime-efficiency/test-cases.md#test-0159): the new JSON builder added one unreviewed dynamic-operation identity. |
| 2026-07-26 | Final candidate after [FIND-0308](README.md#find-0308) | Windows PowerShell 5.1 | `test-runtime-efficiency.tests.ps1` | [TEST-0158](../FEAT-0039-v0130-test-runtime-efficiency/test-cases.md#test-0158), [TEST-0159](../FEAT-0039-v0130-test-runtime-efficiency/test-cases.md#test-0159), and [TEST-0162](../FEAT-0040-v0131-batched-instruction-graph-acquisition/test-cases.md#test-0162) passed in 6.8 seconds after replacing the scriptblock invocation with a direct modular helper. |
...
| 2026-07-26 | [PR #138](https://github.com/hasanmanzak/meAndAI/pull/138) candidate before [FIND-0309](README.md#find-0309) | GitHub-hosted Windows PowerShell 5.1 | [Protocol validation run](https://github.com/hasanmanzak/meAndAI/actions/runs/30201366801) | [TEST-0153](../FEAT-0037-v0126-instruction-graph-adoption-containment/test-cases.md#test-0153) failed because the native stdin payload began with a UTF-8 BOM; Linux independently exposed unlinked delivery-evidence references. |
| 2026-07-26 | Final candidate after [FIND-0309](README.md#find-0309) | Windows PowerShell 5.1 / PowerShell 7 | `source-graph-dispatch.case.ps1` with a BOM-bearing ambient console input encoding | Expected red reproduced in 3.3 seconds before production correction; both runtimes then passed in 3.0 / 3.2 seconds with exact BOM-free bytes and restoration of both caller encodings. |
| 2026-07-26 | Final candidate after [FIND-0309](README.md#find-0309) | Canonical local validation | `tests/protocol.tests.ps1` | Passed all discovered suites in 2,026.3 seconds. |
