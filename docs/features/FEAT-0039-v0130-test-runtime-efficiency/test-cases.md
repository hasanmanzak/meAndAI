...
[TEST-0138](../FEAT-0032-general-capability-test-architecture/test-cases.md) architecture regression after those owners passed: inline operation-
...
[TEST-0138](../FEAT-0032-general-capability-test-architecture/test-cases.md) plus runtime contracts pass under PowerShell 7.6.4 and Windows
PowerShell 5.1. The same run's Windows step also reached every expensive owner
before the identical [TEST-0138](../FEAT-0032-general-capability-test-architecture/test-cases.md) failure: quick-adoption 821.5 seconds, bootstrap
