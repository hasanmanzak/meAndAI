...
| --- | --- | --- | --- | --- |
| 2026-07-22 | [`327a832f24c981c9f55c34a8ec8d9859667ffb06`](https://github.com/hasanmanzak/meAndAI/commit/327a832f24c981c9f55c34a8ec8d9859667ffb06) | Windows PowerShell 5.1 / exact detached [PR #94](https://github.com/hasanmanzak/meAndAI/pull/94) tree | Measurement-only command-discovery plus Git Trace2 over the hotspot owners | Stopped: observer overhead was prohibitive; hosted [PR #94](https://github.com/hasanmanzak/meAndAI/pull/94) durations remain trigger evidence only |
| 2026-07-22 | [`6b01299cfe484c900944b7435d4fef43b11fc38d`](https://github.com/hasanmanzak/meAndAI/commit/6b01299cfe484c900944b7435d4fef43b11fc38d) | Windows PowerShell 5.1 / immutable v0.12.7 task base | Low-overhead breakpoint plus Git Trace2 observer `sha256:ed9a8290b24b191274f35c4bef2cd9af14157e2927be94848a2561a54294e04b` | Quick `All` hit the bounded 30-minute ceiling after 15,026 Git starts; diagnostic lower bound was 85 init, 65 clone, 368 ls-tree, and 330 cat-file; no success authority was published |
| 2026-07-22 | [`6b01299cfe484c900944b7435d4fef43b11fc38d`](https://github.com/hasanmanzak/meAndAI/commit/6b01299cfe484c900944b7435d4fef43b11fc38d) | Exact committed executable routes | Owner-level fixture and graph construction inventory | Frozen baselines/targets: quick init 47/11; bootstrap init 38/3, clone 72/2, bundle 2/2, push 36/36; graph child process 6/4 and isolated acquisition 5/3 |
...
[TEST-0138](../FEAT-0032-general-capability-test-architecture/test-cases.md#test-0138) architecture regression after those owners passed: inline operation-
...
[TEST-0138](../FEAT-0032-general-capability-test-architecture/test-cases.md#test-0138) plus runtime contracts pass under PowerShell 7.6.4 and Windows
PowerShell 5.1. The same run's Windows step also reached every expensive owner
before the identical [TEST-0138](../FEAT-0032-general-capability-test-architecture/test-cases.md#test-0138) failure: quick-adoption 821.5 seconds, bootstrap
...
is made. Residual work remains assigned to [TASK-0002](https://github.com/hasanmanzak/meAndAI/issues/98). The next corrected
