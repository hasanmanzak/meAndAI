...
| [TEST-0105](../FEAT-0020-v095-streamed-codex-cancellation/test-cases.md#test-0105) | [SUBF-0118](README.md#subf-0118) delivery convergence | Prove the first mock JSONL event is consumed while the exact fixture PID and process-start identity remain live, then retain every bounded presentation assertion. | Hosted Windows validation cannot depend on a bidirectional file-visibility handshake; incremental consumption, safe rendering, exit state, and all later events remain mandatory. | Related retained delivery-infrastructure evidence; no new scenario | Focused PowerShell 7 / Windows PowerShell 5.1 pass; final hosted head pending |
...
| 2026-07-27 | [`120b04f6d724a1c01971d59332f3c54b2ada789c`](https://github.com/hasanmanzak/meAndAI/commit/120b04f6d724a1c01971d59332f3c54b2ada789c) | PowerShell 7 / Windows PowerShell 5.1 | `quick-adoption-streaming.tests.ps1` | Passed [TEST-0105](../FEAT-0020-v095-streamed-codex-cancellation/test-cases.md#test-0105) and [TEST-0106](../FEAT-0020-v095-streamed-codex-cancellation/test-cases.md#test-0106) in 9.7 / 11.3 seconds after replacing the file acknowledgment with exact live PID plus process-start-ticks evidence. Production code and cancellation semantics remain unchanged. |
