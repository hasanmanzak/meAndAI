...
| --- | --- | --- | --- | --- | --- | --- |
| `TEST-0131` <a name="test-0131"></a> | [SUBF-0055](README.md#subf-0055) | Inspect the canonical prompt for pinned authority, material-change entry, disposition and dependency rules, per-finding evidence/review, finite confirmation, blocked/waiting outcomes, and publication mode. | The prompt faithfully invokes [DEC-0015](../../decisions/DEC-0015-event-triggered-stability-cycles.md), defaults to report-only, distinguishes local convergence from full completion, remains blocked without final-push authority, permits only an explicitly authorized review-branch push to enter Waiting, and never permits a tag or GitHub Release. | Structural / semantic fidelity / authority | Passed | `tests/protocol.tests.ps1` |
| `TEST-0132` <a name="test-0132"></a> | [SUBF-0055](README.md#subf-0055) | Inspect documentation links and both consumer integration models; search managed paths, templates, workflows, migrations, and prompt text for automatic installation or scheduling. | Maintainers can resolve one immutable canonical prompt; no consumer-owned copy, goal, task, schedule, workflow, updater path, migration, or self-activation is created. | Structural / reachability / negative | Passed | `tests/protocol.tests.ps1` |

## Required coverage

- Normative authority and direct [DEC-0015](../../decisions/DEC-0015-event-triggered-stability-cycles.md) fidelity.
...
| --- | --- | --- | --- | --- |
| 2026-07-18 | [`e226293`](https://github.com/hasanmanzak/meAndAI/commit/e226293acc5967f8b4e3049c54f206ed78bc9fd4) baseline | Windows / repository baseline | Existing [TEST-0096](../FEAT-0015-stability-consistency-mandate/test-cases.md#test-0096), [TEST-0097](../FEAT-0015-stability-consistency-mandate/test-cases.md#test-0097), [TEST-0098](../FEAT-0015-stability-consistency-mandate/test-cases.md#test-0098), and [TEST-0099](../FEAT-0015-stability-consistency-mandate/test-cases.md#test-0099) | Normative cycle green; TEST-0131 and TEST-0132 not yet implemented |
