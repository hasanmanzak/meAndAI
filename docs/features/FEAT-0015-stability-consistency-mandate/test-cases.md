...
| --- | --- | --- | --- | --- |
| 2026-07-16 | Immutable v0.8.6 commit `a3d58a9cee00b9914c40adcd8e93dff53bed235a` | Windows PowerShell 5.1 | `powershell -NoProfile -ExecutionPolicy Bypass -File tests/protocol.tests.ps1` | Baseline passed in 561.6 seconds; TEST-0096 through TEST-0099 did not yet exist |
...
| 2026-07-16 | FEAT-0015 correction queue | Windows PowerShell 5.1 | Repeated focused `tests/protocol.tests.ps1 -StructureOnly` runs | [FIND-0133](README.md), [FIND-0135](README.md), [FIND-0134](README.md), and [FIND-0136](README.md) each demonstrated the intended red state; corrected runs returned only the intentional current-feature status gate; [FIND-0137](README.md) strengthened false-positive boundaries from review evidence |
...
| 2026-07-16 | FEAT-0015 evidence tree | Windows PowerShell 5.1 | `powershell -NoProfile -ExecutionPolicy Bypass -File tests/protocol.tests.ps1 -StructureOnly` | Passed in 3.7 seconds after [FIND-0139](README.md) separated local eligibility from external push evidence |
