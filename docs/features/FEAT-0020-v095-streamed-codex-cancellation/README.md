...
| `RISK-0094` <a name="risk-0094"></a> | Cancellation cleanup | Ctrl+C leaves Codex or its descendants running against a temporary clone | Mitigating / launcher maintainer | Invoke one child-tree stop helper from timeout and `finally`, then verify owned-root cleanup; [TEST-0106](test-cases.md#test-0106) |
