...
| --- | --- | --- | --- | --- |
| 2026-07-22 | Immutable baseline [`6de31e0`](https://github.com/hasanmanzak/meAndAI/commit/6de31e0c318666bfa1fb884f2f5a791ecaf0fd3e) / v0.12.6 | GitHub REST API `2026-03-10` and local Windows PowerShell 5.1 | Live PR response plus exact issue-event inspection | Live response omits `merge_commit_sha`; its exact pull-request event stream contains one `merged` event with a canonical `commit_id`. |
