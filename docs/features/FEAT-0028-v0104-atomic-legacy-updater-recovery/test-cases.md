...
| --- | --- | --- | --- |
| 2026-07-18 | Windows PowerShell 5.1, unrestricted local Git fixture | `tests/protocol-update-adapter.tests.ps1` | Passed; frozen project-neutral validator blob `1dffab9c6b6d6f22aedb83c313b95d7b0f275183`, core-only unique [TEST-0001](../FEAT-0001-common-development-protocol/test-cases.md) failure, atomic exact 13-path proposal green, second plan exact no-op |
...
| 2026-07-18 | Windows PowerShell 5.1, unrestricted local Git fixture | `tests/protocol-update.tests.ps1` after final [FIND-0158](../FEAT-0029-v0110-protocol-aware-initial-adoption/README.md) correction | Passed in 34.8 s; all adapter scenarios and the [complete protocol-update suite](../../../tests/capabilities/consumer-update/protocol-update.tests.ps1) ownership emitted green. Two preceding sandboxed attempts hit only Git-for-Windows `sh.exe` signal-pipe error 5 in the unchanged `TEST-0125` clone fixture. |
