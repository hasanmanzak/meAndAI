...
- Changing repository visibility, purchasing a plan, or treating the
  unprotected `main` condition in `RISK-0076` as resolved.
...
7. The prior disposition count and TEST-0002 wording match their canonical
