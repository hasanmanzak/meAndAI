...
- Every declared variant from [FIND-0126](README.md), including negative mutation checks.
...
| 2026-07-16 | Immutable v0.8.5 commit `7c06dfad75ab7b327d46c7b8f8d7cb541bab3896` | Post-publication preflight | Compare release-target FEAT-0014 state with the [TEST-0065](../FEAT-0011-stability-closure/test-cases.md) contract | Ineligible for verification: the feature was not `Complete` and post-publication checks were mixed into Definition of Done; recorded as [FIND-0132](README.md) before dispatch |
