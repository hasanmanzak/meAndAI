...
| 2026-07-16 | Immutable v0.8.5 commit `7c06dfad75ab7b327d46c7b8f8d7cb541bab3896` | Post-publication preflight | Compare release-target FEAT-0014 state with the `TEST-0065` contract | Ineligible for verification: the feature was not `Complete` and post-publication checks were mixed into Definition of Done; recorded as `FIND-0132` before dispatch |
...
| Pending | Merged v0.8.6 commit | GitHub Actions and post-publication authority | Hosted CI and exact publication verifier | Pending; exact facts belong to issue #43 and the GitHub Release |
