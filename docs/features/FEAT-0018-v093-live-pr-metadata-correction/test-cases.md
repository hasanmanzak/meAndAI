...
| --- | --- | --- | --- | --- |
| 2026-07-16 | `v0.9.2` release asset | Windows PowerShell 5.1 / GitHub CLI | Derdini quick-adoption run recorded in [issue #53](https://github.com/hasanmanzak/meAndAI/issues/53) | External red: successful lifecycle and valid same-repository draft were followed by false repository-origin rejection |
