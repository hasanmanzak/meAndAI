...
- [ ] One canonical full suite passes on the final committed candidate tree.
...
| Final committed-tree suite | Pending after [FIND-0343](#find-0343) correction. |
