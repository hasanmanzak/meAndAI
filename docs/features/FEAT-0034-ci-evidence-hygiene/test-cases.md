...
| 2026-07-19 | working tree before [SUBF-0062](README.md) | Windows PowerShell 5.1 | `powershell -NoProfile -ExecutionPolicy Bypass -File tests/capabilities/consumer-update/managed-merge-finalization.tests.ps1` | Expected red: eight synthetic finalization lines reached the inherited outer summary and no invocation-owned output was captured |
| 2026-07-19 | working tree before [SUBF-0063](README.md) | Windows PowerShell 5.1 | `powershell -NoProfile -ExecutionPolicy Bypass -File tests/capabilities/workflow-efficiency/main-validation-route.tests.ps1` | Expected red: the route module and exact-tree workflow/protocol contracts were absent |
| 2026-07-19 | working tree after correction | Windows PowerShell 5.1 | `powershell -NoProfile -ExecutionPolicy Bypass -File tests/capabilities/consumer-update/managed-merge-finalization.tests.ps1` | Green: [TEST-0108](../FEAT-0022-v097-managed-merge-finalization/test-cases.md), [TEST-0109](../FEAT-0022-v097-managed-merge-finalization/test-cases.md), [TEST-0110](../FEAT-0022-v097-managed-merge-finalization/test-cases.md), [TEST-0112](../FEAT-0023-v0100-idempotent-consumer-lifecycle/test-cases.md), and `TEST-0142` passed with isolated summary evidence |
...
| 2026-07-19 | candidate `0e44135584c14145b50180f28874680e4309ba07` | GitHub-hosted Ubuntu and Windows | [PR #86](https://github.com/hasanmanzak/meAndAI/pull/86) [run 29692117634](https://github.com/hasanmanzak/meAndAI/actions/runs/29692117634) | Expected red for [FIND-0175](README.md): a pull-request event supplied an empty `before` field and both jobs failed at PowerShell parameter binding before selecting `Full` |
