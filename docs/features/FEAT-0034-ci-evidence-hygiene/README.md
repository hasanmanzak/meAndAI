...
| Field | Value |
| --- | --- |
| Classification | Backward-compatible CI and test-isolation correction / [BUG-0015](https://github.com/hasanmanzak/meAndAI/issues/85), [BUG-0016](https://github.com/hasanmanzak/meAndAI/issues/85) |
| Status | Complete |
...
- Consumers and dependencies: the affected surfaces are the canonical
  ...
  [DEC-0019](../../decisions/DEC-0019-hosted-runner-efficiency.md). GitHub REST evidence and local Git are read-only dependencies.
...
It did not expand into consumer updater behavior or unrelated [issue #44](https://github.com/hasanmanzak/meAndAI/issues/44).
...
- [x] Delivery pull request is cross-linked through [issue #85](https://github.com/hasanmanzak/meAndAI/issues/85) without an
      evidence-only candidate commit.
- [x] Applicable hosted CI remains a mandatory pre-merge external gate whose
      exact result is recorded in [issue #85](https://github.com/hasanmanzak/meAndAI/issues/85) or its linked pull request.
