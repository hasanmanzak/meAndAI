...
| Status | Definition-of-Ready analysis in progress / C# development not authorized; bounded [TEST-0106](../FEAT-0020-v095-streamed-codex-cancellation/test-cases.md#test-0106) harness and [TEST-0124](../FEAT-0027-v0104-runner-minute-efficiency/test-cases.md#test-0124) Windows `Full` job-ceiling corrections authorized; exact-hosted confirmation pending |
