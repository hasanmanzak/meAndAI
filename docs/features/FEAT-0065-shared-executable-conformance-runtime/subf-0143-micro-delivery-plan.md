...
| Status | A `19/20` (`95%`), `32/32`; [TEST-0210](test-cases.md#test-0210) `Planned`; Resource R=`0024` hosted green; Converge V1 diagnostic/no success, V2 `FrozenDesign`/corrected-design hosted pending after renewed D/RT `0/0/0`. No completion/DoD. |
...
| `A-CONVERGE-02` | V1 immutable diagnostic; V2 `FrozenDesign`/hosted pending | P/R/G `NotApplicable`; no FQN/ordinal/marker/TRX/`TestOnlyGreen`; V1 exit `1`, never rerun | V1 runs passed then `completed=0` failed closed; V2 owns the corrected oracle and possible `CompletionRecommended` | V1/V2 D/RT `0/0/0`; A remains `19/20`, `32/32`; final reviews pending | [Frozen audit contract](subf-0143-typed-evaluation-kernel-design.md#a-converge-02-freeze) |
