...
| Status | A `19/20`, `32/32`; [TEST-0210](test-cases.md#test-0210) `Planned`; Resource hosted green; V1/V2 diagnostic; V3 `FrozenDesign`/hosted pending after D/RT `0/0/0`. No completion/DoD. |
...
| `A-CONVERGE-02` | V1/V2 diagnostic; V3 `FrozenDesign`/inactive | P/R/G `NotApplicable`; no executable surface; V1/V2 never rerun | V3 retains all oracles and adds fail-closed entry/root custody | A `19/20`, `32/32`; D/RT `0/0/0`; exact-head hosted gate pending | [Audit contract](subf-0143-typed-evaluation-kernel-design.md#a-converge-02-freeze) |
