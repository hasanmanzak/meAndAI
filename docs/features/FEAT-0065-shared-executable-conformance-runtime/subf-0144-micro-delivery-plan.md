...
| Status | `AcceptedFrozenDesign`; `POLICY-SURFACE-FRAMING-01`, `EXTENSION-AUTHORITY-01`, and `EXTENSION-EVALUATION-01` are packet-local `ReviewedLocalGreen`; `WAIVER-DISPOSITION-01` is the next ordered packet and is inactive in this commit |
