...
| Status | `AcceptedFrozenDesign`; `POLICY-SURFACE-FRAMING-01`, `EXTENSION-AUTHORITY-01`, `EXTENSION-EVALUATION-01`, and `WAIVER-DISPOSITION-01` are packet-local `ReviewedLocalGreen`; `DEBT-ENFORCEMENT-01` is the next ordered packet and is inactive in this commit |
