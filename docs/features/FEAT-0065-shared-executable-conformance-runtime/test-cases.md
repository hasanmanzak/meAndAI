...
design gate. Its first five ordered packets through debt enforcement are
`ReviewedLocalGreen`, with protected-policy cumulative `5/5`, full
Conformance `70/70`, and Domain `98/98`; canonical
`PROTECTED-POLICY-DEBT-RED-0004` is preserved. The first input-custody
...
hosted green. [SUBF-0144](README.md#subf-0144) is `AcceptedFrozenDesign`;
`SELF-CONSUMPTION-01` is next and permitted but remains uninvoked, and
[TEST-0211](#test-0211) remains Planned. Feature
