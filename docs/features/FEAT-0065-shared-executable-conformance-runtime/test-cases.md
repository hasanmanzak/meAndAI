...
pending at B `10/11`, cumulative A+B `42/43`. B-CODEC-DERIVATION is
...
format and diff are green. The implementation head remains hosted pending.
...
implementation/design head is exact-head hosted green. B-CONVERGE, parent
