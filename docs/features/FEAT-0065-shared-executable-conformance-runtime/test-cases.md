...
B-CONVERGE is merged/exact-main green. ContractSlice C
is `FrozenDesign`/inactive at `0/11` pending its synchronized design head's
exact hosted gate; later scopes remain held.
