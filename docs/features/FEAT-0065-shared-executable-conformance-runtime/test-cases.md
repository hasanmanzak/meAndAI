...
exact-head hosted green at B `9/11`, cumulative A+B `41/43`. B-SEALED-CONTEXT
is `FrozenDesign`/inactive pending its synchronized design-head hosted gate.
...
exact synchronized design head is hosted green.
