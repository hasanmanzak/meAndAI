...
[SUBF-0144](README.md#subf-0144) is `AcceptedFrozenDesign` at its exact hosted
design head. Its surface/framing, authority, evaluation, and waiver packets are `ReviewedLocalGreen`;
later packets remain ordered and [TEST-0211](#test-0211) Scenario activation remains held.
Feature completion/DoD, release, and publication remain held.
The append-only
