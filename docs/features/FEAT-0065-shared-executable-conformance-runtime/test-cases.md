...
that plan. D is inactive until the design-delivery head is hosted green and the
maintainer explicitly accepts it. TEST-0210 remains `Planned`; Scenario/status/
