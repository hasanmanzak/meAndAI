...
local commits. The convergence audit records local `CompletionRecommended`;
the Results/closure cohort exact-head hosted gate is pending. Every later scope
remains held.
