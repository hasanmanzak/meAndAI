...
[SUBF-0144](README.md#subf-0144) directive authorizes its design cohort only;
[TEST-0211](#test-0211) implementation remains inactive until `AcceptedFrozenDesign` and its
exact design-head hosted gate. Feature completion/DoD, release, and publication
remain held.
The append-only
