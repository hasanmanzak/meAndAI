...
exact-head hosted green; applicability plan is `ReviewedLocalGreen`, C is
`6/11`, current A+B+C is `49/49`, and
`C-APPLICABILITY-PLAN-01` is frozen/inactive; later scopes remain held.
