...
A `26/26`. Renewed D/RT closed `0/0/0`; exact committed-tree graph evidence
below 4096 and exact-head hosted green remain before LR/P/R/C#. Every later packet remains
