...
### `A-CONVERGE-02` V1/V2 diagnostics / V3 FrozenDesign <a name="a-converge-02-freeze"></a>
...
V1/V2 are immutable diagnostics; V3 adds fail-closed entry/root custody and the
one-attempt launcher. V3 D/RT is `0/0/0`, but its exact-head hosted design gate
is pending. Only fully green V3 yields `CompletionRecommended`; only the
