...
checkpoint `f64860ef...`, and draft PR #174 close the bounded recovery
checkpoint. The remote-equal record-sync head becomes the next-packet
predecessor. These results do not make [TEST-0210](#test-0210) `Passing` or
activate a successor.
