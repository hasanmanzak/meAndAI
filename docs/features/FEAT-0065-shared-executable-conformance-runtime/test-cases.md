...
Applicability cohorts are exact-head hosted green; C is `7/11`, and current
A+B+C is `50/50`. Applicability-plan R=0006 is
...
success/no-retry. Corrected R=0014 is `FrozenDesign`/inactive pending its
synchronized correction-head hosted gate; every later scope remains held.
