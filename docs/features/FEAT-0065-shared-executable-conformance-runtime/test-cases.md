...
never reruns it. The same-object Tests-owned mirror core is local green with its
...
Focused/B/full Conformance/Domain are `1/1`, `4/4`, `36/36`, and `98/98`; the
exact implementation head remains hosted pending and every later packet remains
predecessor-gated.
