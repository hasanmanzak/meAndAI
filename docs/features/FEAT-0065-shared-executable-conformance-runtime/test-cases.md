...
`13m46s` with publication skipped. Evaluation Plan is `FrozenDesign`/inactive
pending its synchronized design-head hosted gate; every later scope remains held.
