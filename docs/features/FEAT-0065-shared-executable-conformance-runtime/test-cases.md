...
`B-WIRE-REPOSITORY-TARGET-01` is
FrozenDesign/inactive pending its own exact design-head hosted gate; every later
packet remains held.
...
`TEST-0210-B-BEHAVIOR-RED-0004`. Its exact demand frame is `318` bytes at
