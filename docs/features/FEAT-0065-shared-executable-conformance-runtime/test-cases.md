...
`ReviewedLocalGreen`. Exact staged-tree/checkpoint evidence remains pending and
unauthorized. These results do not make [TEST-0210](#test-0210) `Passing` or
