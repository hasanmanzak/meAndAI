...
design gate. Its surface/framing, authority, evaluation, and waiver packets
remain `ReviewedLocalGreen`, with protected-policy cumulative `4/4`, full
Conformance `69/69`, and Domain `98/98`; canonical
...
green. [SUBF-0144](README.md#subf-0144) is `AcceptedFrozenDesign`;
`DEBT-ENFORCEMENT-01` green work has resumed but is not complete, and
