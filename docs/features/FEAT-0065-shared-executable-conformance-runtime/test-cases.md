...
### `A-CONVERGE-02` V1/V2/V3 diagnostics / V4 FrozenDesign <a name="a-converge-02-freeze"></a>
...
all oracles and changes only lexical timestamp sealing. V4 D/RT is `0/0/0`;
the exact-head hosted design gate remains pending. Only fully green V4 yields `CompletionRecommended`; only the
