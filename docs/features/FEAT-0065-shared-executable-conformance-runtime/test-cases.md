...
`B-WIRE-GOVERNED-TEXT-01` is now FrozenDesign/inactive: the normative design
freezes same-object Tests-only carriers, exact Repository/Provider/empty bytes,
strict UTF-8/BOM and location-tail precedence, body/payload boundaries, one
direct governed-text Fact, marker ordinal `0003`, and a two-test-file
`1,200`-line ceiling. Its red remains prohibited until this synchronized design
head is pushed and exact-head hosted green; every later packet remains gated.
