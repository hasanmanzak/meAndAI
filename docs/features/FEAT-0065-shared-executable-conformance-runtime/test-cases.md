...
R=0005 is accepted once and never rerun; repository-target is
`ReviewedLocalGreen` with its implementation head hosted pending. B is `6/11`,
cumulative A+B is `38/43`; B-RESOURCE and every later packet remain held.
