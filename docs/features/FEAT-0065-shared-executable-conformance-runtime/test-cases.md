...
resolved [FIND-0444](README.md#find-0444). [TEST-0210](#test-0210) stays `Planned`;
`A-INDEX-SLOT-01` is now `ReviewedLocalGreen`, `A-PARSER-INDEX-01` remains
