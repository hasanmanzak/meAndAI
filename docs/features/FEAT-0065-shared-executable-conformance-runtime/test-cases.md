...
green; `C-SURFACE-ACTIVATION-01` is `ReviewedLocalGreen`, C is `3/11`, current
A+B+C is `46/46`, and registration-mismatch is next without an intermediate
push/hosted claim; later scopes remain held.
