...
Windows in `46m51s`, with publication correctly skipped. Eighteen of twenty
live packets are `ReviewedLocalGreen` (`90%`). `A-LIFECYCLE-01` is packet-local
`ReviewedLocalGreen`;
