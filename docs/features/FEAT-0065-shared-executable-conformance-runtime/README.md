...
| Status | ContractSlice A-D and final [TEST-0210](test-cases.md#test-0210) activation are immutable merged/exact-main hosted-green predecessor evidence at `A32/B11/C11/D11` and `65/65`. [SUBF-0144](#subf-0144)/[TEST-0211](test-cases.md#test-0211) merged through [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186). [SUBF-0154](#subf-0154) `REPORT-SEALING-01` merged through [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190). The common [FIND-0466](#find-0466)/[FIND-0467](#find-0467) design checkpoint merged through [PR #191](https://github.com/hasanmanzak/meAndAI/pull/191) at exact main [`5bd13520444643d022ef1b421f9cbee48e29b014`](https://github.com/hasanmanzak/meAndAI/commit/5bd13520444643d022ef1b421f9cbee48e29b014); exact-main [run 32566870206](https://github.com/hasanmanzak/meAndAI/actions/runs/32566870206) is green. [FIND-0467](#find-0467) R0020 is accepted/immutable and its D selector packet is `ReviewedLocalGreen`; final record-synchronized graph, PS7/PS5.1 StructureOnly and publication-evidence gates are green, while commit, exact-head hosted, merge and exact-main gates remain pending. [FIND-0466](#find-0466) remains `AcceptedFrozenDesign`; R0019/C implementation waits for D exact-main green. [TEST-0209](test-cases.md#test-0209) remains Planned/inactive until both corrections are merged/exact-main hosted green and report sealing is reconciled. Feature DoD, release and publication remain unclaimed. |
| Hosted correction | Historical A-D correction evidence remains immutable in its owning findings. [FIND-0462](#find-0462) and [FIND-0463](../FEAT-0040-v0131-batched-instruction-graph-acquisition/README.md#find-0463) merged through [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186); the report-sealing [FIND-0464](#find-0464) custody remains immutable and [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190) is exact-main hosted green. Correction-design [PR #191](https://github.com/hasanmanzak/meAndAI/pull/191) is exact-main hosted green. [FIND-0467](#find-0467) has accepted local R/green evidence but no implementation push, hosted, merge, release or publication claim; [FIND-0466](#find-0466) remains design-only. |
| Target version | 0.17.0 |
| Issue | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) |
| Pull request | Completed [SUBF-0152](#subf-0152): [PR #170](https://github.com/hasanmanzak/meAndAI/pull/170); completed [SUBF-0153](#subf-0153): [PR #173](https://github.com/hasanmanzak/meAndAI/pull/173); merged A-D: [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174), [PR #177](https://github.com/hasanmanzak/meAndAI/pull/177), [PR #178](https://github.com/hasanmanzak/meAndAI/pull/178), [PR #184](https://github.com/hasanmanzak/meAndAI/pull/184); final activation [PR #185](https://github.com/hasanmanzak/meAndAI/pull/185); merged protected policy [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186); merged report sealing [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190); merged correction design [PR #191](https://github.com/hasanmanzak/meAndAI/pull/191); [D implementation authority](https://github.com/hasanmanzak/meAndAI/issues/165#issuecomment-5379758091); D selector implementation PR pending |
...
| `FIND-0403` <a name="find-0403"></a> | Public or caller-authored receipts could be mistaken for admission authority, and canonical payload parsing could run twice across [FEAT-0067](../FEAT-0067-evidence-acquisition-managed-consumer-integration/README.md) and the kernel. | `Blocking` architecture was resolved by manifest-bound untrusted proof candidates, one plan-bound Conformance qualification/cache session, and admission without codec rerun. Historical B mirrors did not implement that production session; [FIND-0466](#find-0466) now owns the missing runtime boundary while the managed-consumer feature retains routing/I/O only. |
...
| `FIND-0415` <a name="find-0415"></a> | Direct [FEAT-0067](../FEAT-0067-evidence-acquisition-managed-consumer-integration/README.md) codec invocation would split release/schema/cache authority from Conformance, while admission still must not decode twice. | `Blocking` architecture requires the plan-bound Conformance qualification session; the B mirror proved the intended once-per-miss behavior but production delivery remained absent. [FIND-0466](#find-0466) reopens that delivery before the managed-consumer feature may consume the seam. |
...
| `FIND-0462` <a name="find-0462"></a> | The [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186) pre-correction candidate's Ubuntu [job 96784311587](https://github.com/hasanmanzak/meAndAI/actions/runs/32486565501/job/96784311587) in [run 32486565501](https://github.com/hasanmanzak/meAndAI/actions/runs/32486565501) ended at the exact 25-minute ceiling with annotation `job exceeded maximum execution time of 25m0s`. A prior manual exact-head Ubuntu run completed in `24m41s`, leaving `19s` of margin. The same old-head run's Windows job passed from `13:23:17` to `14:13:23` in about `50m06s`, with publication skipped; this supports retaining Windows `55` but is not replacement-head evidence, and no otherwise-hidden Ubuntu result is inferred. | Classification `VerifiedDefect`; disposition `CorrectedLocal`; severity `low`; confidence `high`; dependencies `None`; priority `p0`; impact rank `high`; status `ReviewedLocalGreen`; owning layer `workflow timeout` / [TEST-0124](../FEAT-0027-v0104-runner-minute-efficiency/test-cases.md#test-0124). Test-first PowerShell 7 StructureOnly ran `507.7s`, exited `1`, and produced exactly the expected timeout-bound problem with oracle SHA-256 `686D1DC3B8C63F41E0410F966AC5E37A2F9BEDB8FCB5842AB6C066941FA4CA40` and stdout SHA-256 `128397BD4C550EE0781F8246E0667686FFD5DB7B4A1D61E1C2945208BA3B356A`; it is not canonical R0006. The first post-transform owner run was locally rejected only by existing clickable-link enforcement for one bare [TEST-0124](../FEAT-0027-v0104-runner-minute-efficiency/test-cases.md#test-0124) occurrence in the owning handoff; after the same-record link correction, the owner passed in `483.7s`. The bounded correction changes only Ubuntu `25` to `30`, retains Windows `55` and post-publication `5`, and preserves topology, routes, invocations, cancellation, filters, owners, C#, API, locks, packages, the `337/2,000` convergence semantics, and canonical R0004/R0005/R0006 custody. Replacement SHA/run facts belong in [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186) or [issue #165](https://github.com/hasanmanzak/meAndAI/issues/165); no evidence-only repository commit is authorized. |

| [FIND-0463](../FEAT-0040-v0131-batched-instruction-graph-acquisition/README.md#find-0463) | The independent bootstrap/quick committed-graph readers used a generic `4 MiB` aggregate default against the canonical schema-2 `8 MiB` contract, rejecting the valid `5,135,238`-byte graph before identity comparison. | Canonical owner [FEAT-0040](../FEAT-0040-v0131-batched-instruction-graph-acquisition/README.md#find-0463) corrected only the test readers: exact loaded-profile blob/aggregate limits plus caller-local `240000`, generic `120000` unchanged. PS7/PS5.1 [TEST-0153](../FEAT-0037-v0126-instruction-graph-adoption-containment/test-cases.md#test-0153), [TEST-0162](../FEAT-0040-v0131-batched-instruction-graph-acquisition/test-cases.md#test-0162), and quick closure are local green; SUBF-0144 semantics, workflow, C#/API, and R custody are unchanged. |
| `FIND-0464` <a name="find-0464"></a> | The exact [TEST-0222](test-cases.md#test-0222) one-shot invocation discovered and executed the sole frozen FQN and produced the accepted TRX, but the external runner then exited `1` because its post-invocation validator required the optional locked xUnit/VSTest `StdOut` presentation to be byte-identical to the marker-only `Message`. The locked transcript instead correctly presented the same result, assembly, FQN and standard assertion stack and contained the marker exactly once. This is an external evidence-oracle overconstraint, not a source, product, test, build, VSTest, or BehaviorRed failure. | Classification `VerifiedDefect`; disposition `Resolved`; severity `low`; confidence `high`; dependencies `None`; priority `p0`; impact rank `high`; owning layer `external expected-red verifier`. The immutable accepted canonical R is frozen at source `1,886` bytes / SHA-256 `F7BC82040457A1CB585B152BBDAD8E69FBA88FC5A7210E6ED167FC079D47581E` and accepted TRX `5,108` bytes / SHA-256 `4FFB591EAB6247DFC661D108501156BEEB33FBE746D191CE7E1B3B2F489D6C83`. The original runner remains diagnostic evidence at `17,741` bytes / SHA-256 `61627FE78AF9E97BD5F5848F7BEBFF011D5E648DDFBDD710FEA74E723E92E89F`; its exit followed the completed child invocation. The first `14,541`-byte no-child verifier revision, SHA-256 `1FDC006F97AF61167021FFBD684A6ADEC08444681CDCC8EC20ED17945D7CC85B`, stopped on a verifier-local scalar `Value` diagnostic without rerunning R or making an R disposition. The corrected `14,541`-byte verifier `D:\Temp\meandai-test0222-report-sealing-red-offline-verifier-4ffb591e-2c7d0a64.ps1`, SHA-256 `79AF177BDAFFA2A03BDAEBE18B84BCCEA059FC9639DA3FAD9040A1404C741F66`, executed with no child, exited `0`, and returned `accepted=true`: source `1,886`/`F7BC...`, runner `17,741`/`61627...`, TRX `5,108`/`4FFB...`, raw/transcript marker counts `2/1`, results/definitions/entries `1/1/1`, counters `total=1`, `executed=1`, `failed=1` with the other `13` zero, RunInfos `1`, attachments `0`. The authoritative marker is the exact `ErrorInfo/Message`; the same-result `StdOut` transcript is permitted only once, with the exact assembly/FQN, one marker occurrence, standard stack presentation, no `StdErr`, foreign result, or independent diagnostic. R was never rerun; the marker-free transform merged through [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190) and exact-main [run 32553183954](https://github.com/hasanmanzak/meAndAI/actions/runs/32553183954) is green. |
| `FIND-0466` <a name="find-0466"></a> | Direct [TEST-0209](test-cases.md#test-0209) composition review proved that the merged public ContractSlice C chain retains only ContextProof projections, discards ordered qualified-model state, substitutes empty producer inputs, lacks the accepted production plan-bound writer/qualification/cache session, and cannot issue the required second evaluation round. Reporting can preserve a reference but cannot create this missing authority. | Classification `VerifiedDefect`; disposition `AcceptedFrozenDesign`; severity `high`; confidence `high`; dependencies historical accepted B writer/qualification/admission/cache contracts and [FIND-0467](#find-0467) only as a common composed-scenario predecessor; priority `p0`; impact rank `high`; owning layer [SUBF-0143](#subf-0143) plan-bound qualification plus producer/reference custody. The accepted [correction design](subf-0143-typed-evaluation-kernel-design.md#c-qualified-reference-custody-01) freezes an exact thirteen-production/eleven-test allowlist, real plan-bound session, admission-stable closed codec state, graph/two-round lifecycle, source-owned ledgers, failure/cache order, direct public fixture, marker `TEST-0210-C-BEHAVIOR-RED-0010`, and R0019. Design delivery is merged/exact-main hosted green through [PR #191](https://github.com/hasanmanzak/meAndAI/pull/191); no C C#, R0019, implementation push/hosted/merge, release or publication mutation exists. [TEST-0209](test-cases.md#test-0209) remains held until both corrections merge/exact-main hosted green and report reconciliation closes. |
| `FIND-0467` <a name="find-0467"></a> | The three real Policy selector resolvers copied their parent canonical value. The accepted relative-child contract requires feature-directory Derived parents to append exact `README.md` or `test-cases.md`; only the decision-record selector copies its exact `DEC-NNNN` parent. Existing D infrastructure coverage asserted only parent reference identity and missed all three canonical values. | Classification `VerifiedDefect`; disposition `CorrectedLocal`; status `ReviewedLocalGreen`; severity `high`; confidence `high`; dependencies [FIND-0466](#find-0466) only as a common design/composed-scenario predecessor, not source ownership; priority `p0`; impact rank `high`; owning layer [SUBF-0143](#subf-0143) real Policy selector semantics. R0020 is accepted/immutable: runner `43,086` bytes / SHA-256 `90BDA5172C04D72DC5AB07DDABABB30398ED10757577B04C51E82D0BC6B19CD0`, red source `26,001` / `B44F6370E391340322F2C0610B877884CCA9B450DA967C9105A0E91385A0593E`, report `12,933` / `CC452127DB21C7D51B62CD63EB6D8AC716CD279F52386A95D948C65F479E5394`, and sole TRX `5,298` / `AD5F3BA680897B7DD8A9BEE0FE6BB3C5FD04703698138C867D35271B6E806E61`. The marker-free two-path correction adds no Fact, public API or topology row and is green at focused `1/1`, D `11/11`, Scenario/A-D `65/65`, full Conformance `73/73`, Domain `98/98`, API/ownership `15/15`, Release `0/0`, format/locks/diff and reviews `0/0/0`; caps are `16/120`, `60/180`, `76/300`. Final record-synchronized graph `4/4`, PS7/PS5.1 StructureOnly and publication evidence `7/7` are green. Commit, push, hosted, merge and exact-main evidence remain pending; release/publication remain unclaimed. |
...
| --- | --- | --- |
| Scenarios | [TEST-0210](test-cases.md#test-0210) and [TEST-0211](test-cases.md#test-0211) Passing/active; [TEST-0222](test-cases.md#test-0222) and [TEST-0209](test-cases.md#test-0209) Planned | Existing owner/workflow activations are merged/exact-main hosted green. [FIND-0466](#find-0466) `AcceptedFrozenDesign` target `66/66` remains inactive; no new owner/workflow mutation. |
| Test code | Original [TEST-0210](test-cases.md#test-0210) `65/65`, protected-policy `7/7`, and report-sealing Cohort 1 are exact-main hosted green; canonical reds remain immutable. D corrected the existing selector Fact locally without changing `65/65`; C alone owns the future 66th Fact. | [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186) merged at [`a291556b2fa3c6fbaac7fa564ed35baadb5e9626`](https://github.com/hasanmanzak/meAndAI/commit/a291556b2fa3c6fbaac7fa564ed35baadb5e9626); [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190) merged at [`997e2658b615212c5a34bc44ec1419282cf86446`](https://github.com/hasanmanzak/meAndAI/commit/997e2658b615212c5a34bc44ec1419282cf86446). [FIND-0467](#find-0467) R0020 is accepted and D is `ReviewedLocalGreen`; [FIND-0466](#find-0466) has no R or implementation yet. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged A [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) / merged B [PR #177](https://github.com/hasanmanzak/meAndAI/pull/177) / merged C [PR #178](https://github.com/hasanmanzak/meAndAI/pull/178) / merged D [PR #184](https://github.com/hasanmanzak/meAndAI/pull/184) / final activation [PR #185](https://github.com/hasanmanzak/meAndAI/pull/185) / correction design [PR #191](https://github.com/hasanmanzak/meAndAI/pull/191) | [FIND-0466](#find-0466) remains `AcceptedFrozenDesign`; [FIND-0467](#find-0467) is `CorrectedLocal`/`ReviewedLocalGreen` with accepted immutable R0020 | [TEST-0210](test-cases.md#test-0210) Passing on immutable `65/65` predecessor and marker-free D correction; C target `66/66` remains inactive | D final external lifecycle pending before C/R0019; no feature DoD, release, or publication. |
| `SUBF-0144` <a name="subf-0144"></a> | [Extensions, waivers, debt, qualification, and predecessor-trusted self-consumption](subf-0144-extension-waiver-self-consumption-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186) | Complete [SUBF-0143](#subf-0143) | [TEST-0211](test-cases.md#test-0211) Passing/active at `7/7`; canonical R0004/R0005/R0006 immutable without rerun | All seven packets and bounded [FIND-0462](#find-0462)/[FIND-0463](../FEAT-0040-v0131-batched-instruction-graph-acquisition/README.md#find-0463) corrections merged/exact-main hosted green at [`a291556b2fa3c6fbaac7fa564ed35baadb5e9626`](https://github.com/hasanmanzak/meAndAI/commit/a291556b2fa3c6fbaac7fa564ed35baadb5e9626) | `AcceptedFrozenDesign`; [FIND-0466](#find-0466) changes no protected-policy semantics; DoD, release and publication unclaimed |
...
| `SUBF-0154` <a name="subf-0154"></a> | [Canonical report sealing, serialization, digest, redaction, and full composed qualification](subf-0154-canonical-report-sealing-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190) | [SUBF-0153](#subf-0153), [SUBF-0143](#subf-0143), [SUBF-0144](#subf-0144) | [TEST-0222](test-cases.md#test-0222) Planned with merged/exact-main-green `REPORT-SEALING-01`; [TEST-0209](test-cases.md#test-0209) Planned | Cohort 1 exact main [`997e2658b615212c5a34bc44ec1419282cf86446`](https://github.com/hasanmanzak/meAndAI/commit/997e2658b615212c5a34bc44ec1419282cf86446); [FIND-0464](#find-0464) retains immutable R custody | `AcceptedFrozenDesign`; Cohort 2 held by [FIND-0466](#find-0466) predecessor correction, then mandatory report reconciliation; completion, release, and publication pending |
