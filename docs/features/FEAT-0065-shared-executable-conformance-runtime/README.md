...
| --- | --- | --- |
| Scenarios | ContractSlice A, B, and C complete; [TEST-0210](test-cases.md#test-0210) `Planned` | D Policy activation and producer infrastructure `ExactHeadHostedGreen`; RULE-0001 and RULE-0002 `ReviewedLocalGreen`; D `6/11`, A+B+C+D/full Conformance `60/60`; first-rules cohort push/hosted pending, RULE-0003 next/inactive, and final activation held. |
