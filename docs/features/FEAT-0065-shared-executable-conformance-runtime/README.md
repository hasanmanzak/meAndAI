...
| Status | Predecessor subfeatures complete; [SUBF-0143](#subf-0143) Gate 2 accepted. A is `19/20` (`95%`) and `32/32`; [TEST-0210](test-cases.md#test-0210) is `Planned`; `A-RESOURCE-01` is exact-head hosted green at accepted immutable R=`0024` through run `31264791256`; `A-CONVERGE-02` is FrozenDesign/inactive pending its records/design head. No A completion or DoD claim. |
...
| --- | --- | --- |
| Scenarios | Predecessor scenarios complete; [TEST-0210](test-cases.md#test-0210) remains `Planned` | A is `19/20` (`95%`) and `32/32`; immutable predecessors retained; `A-RESOURCE-01` exact-head hosted green; `A-CONVERGE-02` FrozenDesign/inactive pending records/design hosted evidence. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / current authority on draft [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) | Gate 2 accepted; immutable predecessor evidence retained | [TEST-0210](test-cases.md#test-0210) `Planned`; A `19/20`, `32/32`; `A-RESOURCE-01` exact-head hosted green at accepted immutable R=`0024` | `A-CONVERGE-02` FrozenDesign/inactive pending its records/design head; B/C/D and final activation held; no completion/DoD. |
