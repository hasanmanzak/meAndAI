...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. A `19/20`, `32/32`; [TEST-0210](test-cases.md#test-0210) `Planned`; Resource hosted green; V1/V2 diagnostic; V3 `FrozenDesign`/hosted pending after D/RT `0/0/0`. No A completion/DoD. |
...
| --- | --- | --- |
| Scenarios | Predecessors complete; [TEST-0210](test-cases.md#test-0210) `Planned` | A `19/20`, `32/32`; Resource hosted green; V1/V2 diagnostic; V3 `FrozenDesign`/hosted pending after D/RT `0/0/0`. |
