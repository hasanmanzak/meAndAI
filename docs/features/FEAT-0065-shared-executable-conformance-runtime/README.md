...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. A `19/20` (`95%`), `32/32`; [TEST-0210](test-cases.md#test-0210) `Planned`; Resource R=`0024` hosted green; Converge V1 diagnostic/no success, V2 FrozenDesign/corrected-design hosted pending. No A completion/DoD. |
...
| --- | --- | --- |
| Scenarios | Predecessors complete; [TEST-0210](test-cases.md#test-0210) `Planned` | A `19/20` (`95%`), `32/32`; Resource hosted green; Converge V1 diagnostic/no success, V2 FrozenDesign/hosted pending. |
