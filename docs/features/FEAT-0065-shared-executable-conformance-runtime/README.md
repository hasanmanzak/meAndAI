...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B surface/codec/repository-tree/governed-text hosted green; repository-target FrozenDesign/inactive pending exact design-head hosted gate; C/D and final activation held. |
