...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A is merged/exact-main green; B surface, codec, and three wires are exact-head hosted green. B-RESOURCE R=0006 is accepted and local green at B `7/11`, A+B `39/43`, exact implementation-head hosted pending; B-CACHE/later packets inactive; [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B surface/codec/three wires hosted green; B-RESOURCE R=0006 accepted/local green with implementation-head hosted pending; B-CACHE, C/D, and activation held. |
