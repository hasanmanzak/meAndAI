...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B surface/codec/three wires/resource hosted green; B-CACHE `FrozenDesign`/inactive pending exact design-head hosted gate; C/D and activation held. |
