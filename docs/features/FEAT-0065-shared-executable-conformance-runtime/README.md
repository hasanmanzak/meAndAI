...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. All three C Activation-cohort packets are `ReviewedLocalGreen`; C is `5/11`, current A+B+C is `48/48`, and the locally complete cohort remains unpushed/hosted-pending. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; all three C Activation packets `ReviewedLocalGreen`, C `5/11`, current A+B+C `48/48`, cohort push/hosted pending; D and activation held. |
