...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B surface/codec/repository-tree hosted green; governed-text frozen/inactive; C/D and final activation held. |
