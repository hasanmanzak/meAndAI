...
| Status | ContractSlice A-D and final [TEST-0210](test-cases.md#test-0210) atomic activation are merged/exact-main hosted green at `A32/B11/C11/D11`, cumulative/full Conformance `65/65`, Scenario/ContractSlice `65/65`, and combined `163/163`. [SUBF-0144](#subf-0144) is `FrozenDesign` with fresh reviews and local design gates green; [TEST-0211](test-cases.md#test-0211) implementation is inactive pending exact design-head hosted green. No feature DoD. |
...
| --- | --- | --- |
| Scenarios | [TEST-0210](test-cases.md#test-0210) complete; [TEST-0211](test-cases.md#test-0211) Planned | Final activation is merged/exact-main hosted green; [SUBF-0144](#subf-0144) is `FrozenDesign` and implementation remains held. |
| Test code | [TEST-0210](test-cases.md#test-0210) Passing at exact main; [TEST-0211](test-cases.md#test-0211) not started | Scenario and ContractSlice each pass `65/65`, combined `163/163`, full Conformance/Domain `65/65` and `98/98`, API/ownership `15/15`; no new executable delta exists. |
