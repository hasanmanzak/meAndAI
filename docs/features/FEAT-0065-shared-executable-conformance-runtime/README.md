...
| Hosted correction | Historical heads and [FIND-0445](#find-0445) through [FIND-0452](#find-0452) retain their exact evidence. The earlier records-only graph-budget and sibling-contract corrections are exact-head hosted-green. A-COMPLETE implementation and the bounded hosted timeout correction are exact-head hosted-green at the immutable identity recorded in [FIND-0457](#find-0457); this record-delivery head still requires its own hosted proof before successor activation. Publication remains held. |
...
| Current immutable delivery | Exact A-COMPLETE packet-local implementation/evidence | [FIND-0457](#find-0457) is resolved. The exact implementation head passed Windows in `44m13s` and Ubuntu in `11m50s`; publication verification was correctly skipped. This record-delivery head still needs hosted proof and publication remains held. |
