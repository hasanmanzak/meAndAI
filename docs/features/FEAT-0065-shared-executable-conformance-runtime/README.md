...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. `C-SURFACE-ACTIVATION-01` is `ReviewedLocalGreen`; C is `3/11`, current A+B+C is `46/46`, and registration-mismatch is next without an intermediate push/hosted claim. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C surface `ReviewedLocalGreen`, C `3/11`, current A+B+C `46/46`, registration-mismatch next; D and activation held. |
