...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B surface/codec/repository-tree/governed-text hosted green; repository-target R=0004 diagnostic-only and canonical R=0005 accepted/local green; its implementation head, B-RESOURCE, C/D, and final activation held. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) | Gate 2 accepted | [TEST-0210](test-cases.md#test-0210) `Planned`; A merged/exact-main green; B surface/codec/repository-tree/governed-text hosted green; repository-target R=0004 diagnostic-only and canonical R=0005 accepted/local green; B `6/11`, A+B `38/43`; implementation head hosted pending | B-RESOURCE/later B packets, C/D/activation held; no DoD. |
