...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A is merged/exact-main green; B surface, codec, three wires, and B-RESOURCE are exact-head hosted green. Resource R=0006 and cache R=0007 are accepted/immutable; B-CACHE is `ReviewedLocalGreen`. B is `8/11`, A+B `40/43`; B-ADMISSION is candidate/inactive pending the exact cache implementation-head hosted gate and its own design freeze. Later packets are inactive; [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B surface/codec/three wires/resource hosted green; B-CACHE `ReviewedLocalGreen`; B-ADMISSION candidate/inactive pending cache implementation-head hosted green and design freeze; C/D and activation held. |
