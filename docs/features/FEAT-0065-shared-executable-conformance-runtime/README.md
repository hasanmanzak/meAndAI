...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A is merged/exact-main green; `B-SURFACE-01` is `ReviewedLocalGreen`, B `2/11`, A+B `34/43`, hosted pending; [TEST-0210](test-cases.md#test-0210) remains `Planned`. No activation/DoD. |
...
activated and locally closed only `B-SURFACE-01`; subsequent B red/test/C#
