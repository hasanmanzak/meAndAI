...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C Activation and Applicability `ExactHeadHostedGreen`, C `7/11`, current A+B+C `50/50`; R=0012/R=0013 diagnostic/no-success, corrected R=0014 frozen/inactive pending correction-head hosted gate; D and activation held. |
