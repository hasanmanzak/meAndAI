...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. The C Activation cohort is `ExactHeadHostedGreen`; applicability plan is `ReviewedLocalGreen`, C is `6/11`, and A+B+C is `49/49`. R=0007 is accepted/immutable; closure is next/`FrozenDesign`, with no cohort push/hosted claim. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C Activation `ExactHeadHostedGreen`, applicability plan `ReviewedLocalGreen`, C `6/11`, current A+B+C `49/49`; closure next/`FrozenDesign`; D and activation held. |
