...
activated and closed `B-SURFACE-01`, then locally closed
`B-CODEC-ACTIVATION-01`; subsequent B red/test/C# implementation, C/D,
...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B structural surface local green; codec activation, C/D, and final activation held. |
