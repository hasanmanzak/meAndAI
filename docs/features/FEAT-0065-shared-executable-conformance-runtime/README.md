...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. The [C micro-delivery plan](subf-0143-contractslice-c-micro-delivery-plan.md) is `FrozenDesign`/inactive at `0/11`, pending its synchronized design head's exact hosted gate. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C `FrozenDesign`/inactive at `0/11` pending its exact design-head hosted gate; D and activation held. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) / merged B [PR #177](https://github.com/hasanmanzak/meAndAI/pull/177) | Gate 2 accepted | [TEST-0210](test-cases.md#test-0210) `Planned`; A+B merged/exact-main green at `43/43`; C [micro plan](subf-0143-contractslice-c-micro-delivery-plan.md) `FrozenDesign`/inactive at `0/11`, exact design-head hosted gate pending | D/activation held; no DoD. |
