...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. C Activation and Applicability are `ExactHeadHostedGreen`; Evaluation Plan and Advance are separate `ReviewedLocalGreen` unpushed commits, C is `9/11`, A+B+C `52/52`, and R=0007/R=0011/R=0014/R=0015 are accepted/immutable. R=0012/R=0013 are diagnostics/no-success; Results/closure waits for Evaluation cohort exact-head hosted green. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| Pull request | Completed [SUBF-0152](#subf-0152): [PR #170](https://github.com/hasanmanzak/meAndAI/pull/170); completed [SUBF-0153](#subf-0153): [PR #173](https://github.com/hasanmanzak/meAndAI/pull/173); accepted [SUBF-0143](#subf-0143) Gate 2 and merged A: [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174); merged/exact-main-green B: [PR #177](https://github.com/hasanmanzak/meAndAI/pull/177); draft C [PR #178](https://github.com/hasanmanzak/meAndAI/pull/178) has an exact-head hosted-green design cohort |
...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C Activation and Applicability `ExactHeadHostedGreen`; Evaluation Plan and Advance separate `ReviewedLocalGreen` unpushed commits; C `9/11`, current A+B+C `52/52`; R=0012/R=0013 diagnostic/no-success, R=0014/R=0015 accepted/immutable; Results/closure held pending Evaluation cohort exact-head hosted green; D and activation held. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) / merged B [PR #177](https://github.com/hasanmanzak/meAndAI/pull/177) / draft C [PR #178](https://github.com/hasanmanzak/meAndAI/pull/178) | Gate 2 accepted | [TEST-0210](test-cases.md#test-0210) `Planned`; A+B merged/exact-main green at `43/43`; C Activation and Applicability `ExactHeadHostedGreen`; Evaluation Plan and Advance separate `ReviewedLocalGreen` unpushed commits; C `9/11`, A+B+C `52/52`; R=0012/R=0013 diagnostic/no-success, R=0014/R=0015 accepted/immutable; Results/closure held pending Evaluation cohort exact-head hosted green | Remaining C execution, D, and activation held; no DoD. |
