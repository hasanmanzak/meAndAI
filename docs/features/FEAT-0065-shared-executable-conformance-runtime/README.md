...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. The C Activation cohort is `ExactHeadHostedGreen`; C is `5/11`, current A+B+C is `48/48`. Applicability R=0006 is diagnostic/no-success; corrected R=0007 is frozen/inactive pending corrected-design hosted green. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
