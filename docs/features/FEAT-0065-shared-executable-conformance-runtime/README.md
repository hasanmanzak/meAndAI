...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A, B, and C are merged/exact-main green. D Policy activation is `ExactHeadHostedGreen` at `3/11`; A+B+C+D/full Conformance is `57/57`. Real producer infrastructure is `FrozenDesign`/inactive pending its design-head hosted gate. [TEST-0210](test-cases.md#test-0210) remains `Planned`; final activation/DoD are held. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A, B, and C complete; [TEST-0210](test-cases.md#test-0210) `Planned` | D Policy activation `ExactHeadHostedGreen` at `3/11`; A+B+C+D/full Conformance `57/57`; producer infrastructure frozen/inactive and final activation held. |
