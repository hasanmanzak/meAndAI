...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C Activation and Applicability `ExactHeadHostedGreen`, C `7/11`, current A+B+C `50/50`; Evaluation Plan frozen/inactive pending design-head hosted gate; D and activation held. |
