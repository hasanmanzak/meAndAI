...
| --- | --- | --- |
| Scenarios | [TEST-0210](test-cases.md#test-0210) complete; [TEST-0211](test-cases.md#test-0211) Planned | Final activation is merged/exact-main hosted green; [SUBF-0144](#subf-0144) is in `FrozenDesignCorrection`, with debt green held pending its exact-head hosted gate. |
...
| `SUBF-0144` <a name="subf-0144"></a> | [Extensions, waivers, debt, qualification, and predecessor-trusted self-consumption](subf-0144-extension-waiver-self-consumption-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) | Complete [SUBF-0143](#subf-0143) | [TEST-0211](test-cases.md#test-0211) / Planned | Original design accepted; four ordered implementation packets `ReviewedLocalGreen`; canonical debt red preserved; correction review `0/0/0` and local gates green | `FrozenDesignCorrection`; debt green resumes automatically after exact correction-head hosted green |
