...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. C surface and registration-mismatch are `ReviewedLocalGreen`; C is `4/11`, current A+B+C is `47/47`, and producer-pipeline is next without an intermediate push/hosted claim. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C surface and registration-mismatch `ReviewedLocalGreen`, C `4/11`, current A+B+C `47/47`, producer-pipeline next; D and activation held. |
