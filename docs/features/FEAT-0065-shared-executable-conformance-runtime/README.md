...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. C Activation, Applicability, and Evaluation are `ExactHeadHostedGreen`; C is `9/11`, A+B+C `52/52`, and R=0007/R=0011/R=0014/R=0015 are accepted/immutable. R=0012/R=0013 are diagnostics/no-success; `C-INTENT-RESULT-01` is `FrozenDesign`/inactive pending its synchronized records/design exact-head hosted gate. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C Activation, Applicability, and Evaluation `ExactHeadHostedGreen`; C `9/11`, current A+B+C `52/52`; R=0012/R=0013 diagnostic/no-success, R=0014/R=0015 accepted/immutable; `C-INTENT-RESULT-01` `FrozenDesign`/inactive pending its records/design exact-head hosted gate; D and activation held. |
