...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A, B, and C are merged/exact-main green; C is `11/11`, A+B+C/full Conformance `54/54`. The [D micro-delivery plan](subf-0143-contractslice-d-micro-delivery-plan.md) is `FrozenDesignCandidate`/inactive pending exact-head hosted design delivery and explicit maintainer acceptance. [TEST-0210](test-cases.md#test-0210) remains `Planned`; D implementation and activation/DoD are held. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A, B, and C complete; [TEST-0210](test-cases.md#test-0210) `Planned` | C merged/exact-main green at `54/54`; D design candidate inactive pending hosted design delivery and maintainer acceptance; activation held. |
