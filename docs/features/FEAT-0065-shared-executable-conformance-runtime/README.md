...
| Status | ContractSlice A-D and final [TEST-0210](test-cases.md#test-0210) activation are immutable merged/exact-main hosted-green predecessor evidence at `A32/B11/C11/D11` and `65/65`. [SUBF-0144](#subf-0144)/[TEST-0211](test-cases.md#test-0211) merged through [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186). [SUBF-0154](#subf-0154) `REPORT-SEALING-01` merged through [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190) at exact main [`997e2658b615212c5a34bc44ec1419282cf86446`](https://github.com/hasanmanzak/meAndAI/commit/997e2658b615212c5a34bc44ec1419282cf86446); exact-main [run 32553183954](https://github.com/hasanmanzak/meAndAI/actions/runs/32553183954) is green. [TEST-0222](test-cases.md#test-0222) remains Planned and its canonical R is immutable without rerun. Direct-composition review exposed [FIND-0466](#find-0466) C graph/round/session custody and [FIND-0467](#find-0467) real Policy selector semantics. Both corrections are `AcceptedFrozenDesign`; the common checkpoint awaits delivery gates. [TEST-0209](test-cases.md#test-0209) remains Planned/inactive until both are implemented, merged, exact-main hosted green, and report sealing is reconciled. Feature DoD, release and publication remain unclaimed. |
| Hosted correction | Historical A-D correction evidence remains immutable in its owning findings. [FIND-0462](#find-0462) and [FIND-0463](../FEAT-0040-v0131-batched-instruction-graph-acquisition/README.md#find-0463) merged through [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186); the report-sealing [FIND-0464](#find-0464) custody remains immutable and [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190) is exact-main hosted green. [FIND-0466](#find-0466) is design-only; no behavior R, implementation, push, hosted, merge, release or publication claim exists for it. |
| Target version | 0.17.0 |
| Issue | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) |
| Pull request | Completed [SUBF-0152](#subf-0152): [PR #170](https://github.com/hasanmanzak/meAndAI/pull/170); completed [SUBF-0153](#subf-0153): [PR #173](https://github.com/hasanmanzak/meAndAI/pull/173); merged A-D: [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174), [PR #177](https://github.com/hasanmanzak/meAndAI/pull/177), [PR #178](https://github.com/hasanmanzak/meAndAI/pull/178), [PR #184](https://github.com/hasanmanzak/meAndAI/pull/184); final activation [PR #185](https://github.com/hasanmanzak/meAndAI/pull/185); merged protected policy [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186); merged report sealing [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190); qualified-reference correction design has no PR yet |
...
| `FIND-0466` <a name="find-0466"></a> | Direct [TEST-0209](test-cases.md#test-0209) composition review proved that the merged public ContractSlice C chain retains only ContextProof projections, discards ordered qualified-model state, substitutes empty producer inputs, lacks the accepted production plan-bound writer/qualification/cache session, and cannot issue the required second evaluation round. Reporting can preserve a reference but cannot create this missing authority. | Classification `VerifiedDefect`; disposition `AcceptedFrozenDesign`; severity `high`; confidence `high`; dependencies historical accepted B writer/qualification/admission/cache contracts and [FIND-0467](#find-0467) only as a common composed-scenario predecessor; priority `p0`; impact rank `high`; owning layer [SUBF-0143](#subf-0143) plan-bound qualification plus producer/reference custody. The accepted [correction design](subf-0143-typed-evaluation-kernel-design.md#c-qualified-reference-custody-01) freezes an exact thirteen-production/eleven-test allowlist, real plan-bound session, admission-stable closed codec state, graph/two-round lifecycle, source-owned ledgers, failure/cache order, direct public fixture, marker `TEST-0210-C-BEHAVIOR-RED-0010`, and R0019. No C#, R, push, hosted, merge, release or publication mutation exists; design delivery remains pending. [TEST-0209](test-cases.md#test-0209) remains held until both corrections merge/exact-main hosted green and report reconciliation closes. |
| `FIND-0467` <a name="find-0467"></a> | The three real Policy selector resolvers copy their parent canonical value. The accepted relative-child contract instead requires feature-directory Derived parents to append exact `README.md` or `test-cases.md`; only the decision-record selector copies its exact `DEC-NNNN` parent. Existing D infrastructure coverage asserted only parent reference identity and missed all three canonical values. | Classification `VerifiedDefect`; disposition `AcceptedFrozenDesign`; severity `high`; confidence `high`; dependencies [FIND-0466](#find-0466) only as a common design/composed-scenario predecessor, not source ownership; priority `p0`; impact rank `high`; owning layer [SUBF-0143](#subf-0143) real Policy selector semantics. The [D selector correction](subf-0143-typed-evaluation-kernel-design.md#d-selector-semantics-correction-01) freezes exactly the Policy resolver and existing D infrastructure-test paths, three golden values, marker `TEST-0210-D-BEHAVIOR-RED-0010`, and R0020. It adds no Fact, public API or topology row. No C#, R, push, hosted, merge, release or publication mutation exists yet. |
...
| Test code | Original [TEST-0210](test-cases.md#test-0210) `65/65`, protected-policy `7/7`, and report-sealing Cohort 1 are exact-main hosted green; all canonical reds remain immutable | [PR #186](https://github.com/hasanmanzak/meAndAI/pull/186) merged at [`a291556b2fa3c6fbaac7fa564ed35baadb5e9626`](https://github.com/hasanmanzak/meAndAI/commit/a291556b2fa3c6fbaac7fa564ed35baadb5e9626); [PR #190](https://github.com/hasanmanzak/meAndAI/pull/190) merged at [`997e2658b615212c5a34bc44ec1419282cf86446`](https://github.com/hasanmanzak/meAndAI/commit/997e2658b615212c5a34bc44ec1419282cf86446). [FIND-0466](#find-0466) has no R or implementation yet. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged A [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) / merged B [PR #177](https://github.com/hasanmanzak/meAndAI/pull/177) / merged C [PR #178](https://github.com/hasanmanzak/meAndAI/pull/178) / merged D [PR #184](https://github.com/hasanmanzak/meAndAI/pull/184) / final activation merged [PR #185](https://github.com/hasanmanzak/meAndAI/pull/185) | Original Gate 2 accepted; [FIND-0466](#find-0466) and [FIND-0467](#find-0467) are `AcceptedFrozenDesign` | [TEST-0210](test-cases.md#test-0210) Passing on immutable `65/65` predecessor; C correction target `66/66` remains inactive | Original predecessor complete; the common C/D correction checkpoint awaits delivery gates before R/implementation; no feature DoD, release, or publication. |
