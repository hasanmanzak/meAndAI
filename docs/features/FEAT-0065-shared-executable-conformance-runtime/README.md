...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B surface/codec activation hosted green; repository-tree wire frozen/inactive; C/D and final activation held. |
