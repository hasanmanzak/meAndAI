...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B surface/codec/three wires/resource/cache hosted green; admission R=0008/R=0009/R=0010 diagnostics/no-success and R=0011 accepted; B-ADMISSION `ReviewedLocalGreen` with implementation head hosted pending; C/D and activation held. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) | Gate 2 accepted | [TEST-0210](test-cases.md#test-0210) `Planned`; A merged/exact-main green; B surface/codec/three wires/resource/cache hosted green; B `9/11`, A+B `41/43`; admission R=0008/R=0009/R=0010 diagnostics/no-success and R=0011 accepted; B-ADMISSION `ReviewedLocalGreen` with implementation head hosted pending | Later B, C/D/activation held; no DoD. |
