...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. The C Activation cohort is `ExactHeadHostedGreen`; both Applicability packets are `ReviewedLocalGreen`, C is `7/11`, and A+B+C is `50/50`. R=0007/R=0011 are accepted/immutable; the cohort awaits one push/exact-head hosted gate and Evaluation remains held. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C Activation `ExactHeadHostedGreen`, both Applicability packets `ReviewedLocalGreen`, C `7/11`, current A+B+C `50/50`; cohort push/hosted gate pending; Evaluation, D, and activation held. |
