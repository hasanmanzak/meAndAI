...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C Activation and Applicability `ExactHeadHostedGreen`, Evaluation Plan `ReviewedLocalGreen`/unpushed, C `8/11`, current A+B+C `51/51`; R=0012/R=0013 diagnostic/no-success, R=0014 accepted/immutable; Evaluation Advance next/`FrozenDesign`; D and activation held. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) / merged B [PR #177](https://github.com/hasanmanzak/meAndAI/pull/177) / draft C [PR #178](https://github.com/hasanmanzak/meAndAI/pull/178) | Gate 2 accepted | [TEST-0210](test-cases.md#test-0210) `Planned`; A+B merged/exact-main green at `43/43`; C Activation and Applicability `ExactHeadHostedGreen`, Evaluation Plan `ReviewedLocalGreen`/unpushed, C `8/11`, A+B+C `51/51`; R=0012/R=0013 diagnostic/no-success, R=0014 accepted/immutable; Evaluation Advance next/`FrozenDesign` | Remaining C execution, D, and activation held; no DoD. |
