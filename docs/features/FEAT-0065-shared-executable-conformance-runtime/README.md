...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C Activation and Applicability `ExactHeadHostedGreen`, C `7/11`, current A+B+C `50/50`; Evaluation design hosted green, R=0012 diagnostic/no-success, corrected R=0013 frozen/inactive pending correction-head hosted gate; D and activation held. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) / merged B [PR #177](https://github.com/hasanmanzak/meAndAI/pull/177) / draft C [PR #178](https://github.com/hasanmanzak/meAndAI/pull/178) | Gate 2 accepted | [TEST-0210](test-cases.md#test-0210) `Planned`; A+B merged/exact-main green at `43/43`; C Activation and Applicability `ExactHeadHostedGreen`, C `7/11`, A+B+C `50/50`; Evaluation design hosted green, R=0012 diagnostic/no-success, corrected R=0013 frozen/inactive pending correction-head hosted gate | Evaluation execution, D, and activation held; no DoD. |
