...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A and B are merged/exact-main green; B is `11/11`, A+B `43/43`. The C Activation cohort is `ExactHeadHostedGreen`; C is `5/11`, current A+B+C is `48/48`, and `C-APPLICABILITY-PLAN-01` is `FrozenDesign`/inactive pending its records/design exact-head hosted gate. [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A and B complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B merged/exact-main green; C Activation `ExactHeadHostedGreen`, C `5/11`, current A+B+C `48/48`; applicability plan frozen/inactive; D and activation held. |
