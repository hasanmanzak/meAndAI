...
| Status | Predecessor subfeatures complete; [SUBF-0143](#subf-0143) Gate 2 accepted. A is `19/20` (`95%`) and `32/32`; [TEST-0210](test-cases.md#test-0210) is `Planned`; `A-RESOURCE-01` is local green at accepted immutable R=`0024`, hosted pending; `A-CONVERGE-02` is Candidate/inactive. No A completion or DoD claim. |
...
| --- | --- | --- |
| Scenarios | Predecessor scenarios complete; [TEST-0210](test-cases.md#test-0210) remains `Planned` | A is `19/20` (`95%`) and `32/32`; immutable predecessors retained; `A-RESOURCE-01` local green/hosted pending; `A-CONVERGE-02` Candidate/inactive. |
