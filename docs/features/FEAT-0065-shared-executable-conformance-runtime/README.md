...
| Status | ContractSlice A-D and final [TEST-0210](test-cases.md#test-0210) atomic activation are merged/exact-main hosted green at `A32/B11/C11/D11`, cumulative/full Conformance `65/65`, Scenario/ContractSlice `65/65`, and combined `163/163`. [SUBF-0144](#subf-0144) is in `FrozenDesignCorrection`: five packets through debt enforcement remain `ReviewedLocalGreen`, canonical R0004 is immutable, and the issued-closure/API-oracle correction is exact-head hosted green. SELF R0005 has not been invoked and is held while the canonical outcome-entry projection allowlist correction completes fresh local and exact-head hosted validation. [TEST-0211](test-cases.md#test-0211) remains Planned. No feature DoD. |
...
| --- | --- | --- |
| Scenarios | [TEST-0210](test-cases.md#test-0210) complete; [TEST-0211](test-cases.md#test-0211) Planned | Final activation is merged/exact-main hosted green; [SUBF-0144](#subf-0144) is in `FrozenDesignCorrection`, with uninvoked SELF R0005 held pending the outcome-projection correction's exact-head hosted gate. |
| Test code | [TEST-0210](test-cases.md#test-0210) Passing at exact main; [TEST-0211](test-cases.md#test-0211) has five `ReviewedLocalGreen` packet checkpoints and immutable canonical R0004 on the separate implementation branch | Scenario and workflow activation remain unchanged; the correction branch is records-only and makes no executable-green claim. |
...
| `SUBF-0144` <a name="subf-0144"></a> | [Extensions, waivers, debt, qualification, and predecessor-trusted self-consumption](subf-0144-extension-waiver-self-consumption-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) | Complete [SUBF-0143](#subf-0143) | [TEST-0211](test-cases.md#test-0211) / Planned | Five ordered packets through debt enforcement `ReviewedLocalGreen`; canonical R0004 immutable; issued-closure/API-oracle correction exact-head hosted; bounded outcome-projection allowlist correction under fresh validation | `FrozenDesignCorrection`; SELF R0005 remains uninvoked until the latest correction is exact-head hosted green |
