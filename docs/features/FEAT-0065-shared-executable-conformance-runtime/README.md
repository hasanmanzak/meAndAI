...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A-D are merged and exact-main green at `A32/B11/C11/D11`, cumulative/full Conformance `65/65`. The final [TEST-0210](test-cases.md#test-0210) atomic-activation design is `FrozenDesign`/inactive pending its records-only exact-head hosted gate and maintainer acceptance; the scenario remains `Planned` and implementation/activation/DoD are held. |
...
| --- | --- | --- |
| Scenarios | ContractSlice A-D complete; [TEST-0210](test-cases.md#test-0210) `Planned` | A-D are merged/exact-main green at `A32/B11/C11/D11`, full Conformance `65/65`. Final atomic-activation design is `FrozenDesign`/inactive pending its design-checkpoint hosted gate and acceptance; activation remains held. |
