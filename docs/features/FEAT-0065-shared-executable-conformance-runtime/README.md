...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. ContractSlice A is merged/exact-main green; B surface, codec, three wires, B-RESOURCE, and B-CACHE are exact-head hosted green. Resource R=0006 and cache R=0007 are accepted/immutable. B is `8/11`, A+B `40/43`; admission R=0008 is immutable diagnostic/no-success, and B-ADMISSION is corrected `FrozenDesign`/inactive pending this exact synchronized corrected-design head's hosted gate. Later packets are inactive; [TEST-0210](test-cases.md#test-0210) remains `Planned`; no activation/DoD. |
...
| --- | --- | --- |
| Scenarios | Predecessors and ContractSlice A complete; [TEST-0210](test-cases.md#test-0210) `Planned` | B surface/codec/three wires/resource/cache hosted green; admission R=0008 diagnostic/no-success; B-ADMISSION corrected `FrozenDesign`/inactive pending exact corrected-design-head hosted gate; C/D and activation held. |
...
| `SUBF-0143` <a name="subf-0143"></a> | [Typed evaluation kernel design](subf-0143-typed-evaluation-kernel-design.md) | [#165](https://github.com/hasanmanzak/meAndAI/issues/165) / merged [PR #174](https://github.com/hasanmanzak/meAndAI/pull/174) | Gate 2 accepted | [TEST-0210](test-cases.md#test-0210) `Planned`; A merged/exact-main green; B surface/codec/three wires/resource/cache hosted green; B `8/11`, A+B `40/43`; admission R=0008 diagnostic/no-success; B-ADMISSION corrected `FrozenDesign`/inactive pending exact corrected-design-head hosted gate | Later B, C/D/activation held; no DoD. |
