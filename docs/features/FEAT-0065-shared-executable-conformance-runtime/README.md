...
| Status | Predecessors complete; [SUBF-0143](#subf-0143) Gate 2 accepted. A `19/20`, `32/32`; [TEST-0210](test-cases.md#test-0210) `Planned`; Resource hosted green; V1/V2/V3 diagnostic; V4 `FrozenDesign`/inactive, D/RT `0/0/0`, exact-head hosted design gate pending. No A completion/DoD. |
...
| --- | --- | --- |
| Scenarios | Predecessors complete; [TEST-0210](test-cases.md#test-0210) `Planned` | A `19/20`, `32/32`; Resource hosted green; V1/V2/V3 diagnostic; V4 `FrozenDesign`/inactive, D/RT `0/0/0`, exact-head hosted design gate pending. |
