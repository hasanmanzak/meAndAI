# FEAT-0061 Adoption Application Test Scenarios
...
| `TEST-0201` <a name="test-0201"></a> | [SUBF-0128](README.md#subf-0128) | Close and finalize through direct and provider routes; publish/resume one proposal lifecycle and compare applicable PowerShell outcomes, credentials, cancellation, interruption, and completed-history cases. | One exact lifecycle and shared journal are reused; closure observes the exact target; secrets remain redacted; recovery is idempotent; unmapped divergence blocks later compatibility migration without transferring authority here. | GitHub / differential / security / recovery | Nearest sibling: [TEST-0069](../FEAT-0012-v082-correction/test-cases.md#test-0069); `Distinct` adoption application closure/finalization and compatibility-evidence contract. | Planned | Future integration/differential tests |
