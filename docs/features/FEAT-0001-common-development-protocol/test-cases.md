...
| `TEST-0006` | `SUBF-0001` | Current release metadata is compared with `VERSION`; historical feature targets are checked only for format. | Current metadata reports `0.1.0` without rewriting history. | Passed | Structural test |
