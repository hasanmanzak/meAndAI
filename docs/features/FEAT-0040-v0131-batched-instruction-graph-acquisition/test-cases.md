...
- One complete four-owner batch-transport inventory: production owners retain
  ...
  [TEST-0152](../FEAT-0037-v0126-instruction-graph-adoption-containment/test-cases.md) self-HEAD fixture runs under and restores preamble-bearing ambient
...
| --- | --- | --- | --- |
| 2026-07-22 | `78c8706e9d4d4f4c020d983b22114165687b475e` | PowerShell 7 / focused instruction-graph owner | [TEST-0151](../FEAT-0037-v0126-instruction-graph-adoption-containment/test-cases.md), [TEST-0152](../FEAT-0037-v0126-instruction-graph-adoption-containment/test-cases.md), and TEST-0161 passed in 84.1s; operation evidence was exactly 2/2 blob processes and 4/4 requests |
| 2026-07-22 | `78c8706e9d4d4f4c020d983b22114165687b475e` | Windows PowerShell 5.1 / focused instruction-graph owner | [TEST-0151](../FEAT-0037-v0126-instruction-graph-adoption-containment/test-cases.md), [TEST-0152](../FEAT-0037-v0126-instruction-graph-adoption-containment/test-cases.md), and TEST-0161 passed in 147.6s; operation evidence was exactly 2/2 blob processes and 4/4 requests |
| 2026-07-22 | Implementation tree through `55764442820c884e8c3115726bb010a0a9004d77` | PowerShell 7 and Windows PowerShell 5.1 / focused test-runtime owner | [TEST-0158](../FEAT-0039-v0130-test-runtime-efficiency/test-cases.md), [TEST-0159](../FEAT-0039-v0130-test-runtime-efficiency/test-cases.md), and TEST-0162 passed in 5.3s and 6.5s respectively |
...
| 2026-07-22 | Post-[FIND-0200](README.md) confirmation | Windows PowerShell 5.1 and PowerShell 7 / focused TEST-0162 plus structural owner | Focused [TEST-0158](../FEAT-0039-v0130-test-runtime-efficiency/test-cases.md) and [TEST-0159](../FEAT-0039-v0130-test-runtime-efficiency/test-cases.md) and [TEST-0162](test-cases.md) passed in 9.3s and 9.2s after the third independent expected reader gained exact one-batch/zero-per-blob regression ownership; `StructureOnly` passed in 7.8s |
| 2026-07-23 | Exact candidate head `9b1b1d1c074294ea455f81439b505fb4b3e491fa` | GitHub-hosted Ubuntu / PowerShell 7 and Windows / PowerShell 5.1 | [Run 29963388824](https://github.com/hasanmanzak/meAndAI/actions/runs/29963388824): Ubuntu passed in 7:01.6; Windows failed in 20:25.9 when a BOM-prefixed first OID made the independent expected-reader batch header invalid |
| 2026-07-23 | [FIND-0206](README.md) correction tree | Windows PowerShell 5.1 and PowerShell 7 / focused instruction-graph and test-runtime owners | Expected red reproduced the one exact invalid-header failure in 114.1s and five TEST-0162 source-contract findings; after AST-scoped guard review, [TEST-0151](../FEAT-0037-v0126-instruction-graph-adoption-containment/test-cases.md) and [TEST-0152](../FEAT-0037-v0126-instruction-graph-adoption-containment/test-cases.md) and [TEST-0161](test-cases.md) passed in 163.6/97.7s with exact 2/2 process and 4/4 request observations, and [TEST-0158](../FEAT-0039-v0130-test-runtime-efficiency/test-cases.md) and [TEST-0159](../FEAT-0039-v0130-test-runtime-efficiency/test-cases.md) and [TEST-0162](test-cases.md) passed in 9.2/8.5s |
