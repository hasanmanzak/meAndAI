...
No production change exists yet. Canonical TEST-0161/0162 code now reproduces
the missing actor-local batch sessions, retained per-blob paths, schema-2
provenance, and operation-route gaps before either actor or the runtime contract
changes. The final structural run accepts both authorities.
