...
- One complete four-owner batch-transport inventory: production owners retain
  ...
  TEST-0152 self-HEAD fixture runs under and restores preamble-bearing ambient
...
| 2026-07-23 | `FIND-0206` correction tree | Windows PowerShell 5.1 and PowerShell 7 / focused instruction-graph and test-runtime owners | Expected red reproduced the one exact invalid-header failure in 114.1s and five TEST-0162 source-contract findings; after AST-scoped guard review, TEST-0151/0152/0161 passed in 163.6/97.7s with exact 2/2 process and 4/4 request observations, and TEST-0158/0159/0162 passed in 9.2/8.5s |
