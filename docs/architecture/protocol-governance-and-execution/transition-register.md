...
| Transition state | Accepted architecture; A and B are immutable merged/exact-main-green history. C is the sole active slice: Activation and Applicability are exact-head hosted green, Evaluation design is hosted green, R=0012 is diagnostic/no-success, and corrected R=0013 is frozen/inactive pending its correction delivery gate. D, final activation, WIP, completion/DoD remain held. |
