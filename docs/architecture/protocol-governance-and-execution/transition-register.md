...
Never-activated `A-CONVERGE-01` is retired/excluded. One-for-one replacement
`A-FULL-MANIFEST-01` is `MaintainerActivated / PreRed`:
its corrected design and record-delivery activation base are exact-head hosted-green; P and canonical R have not yet executed. Every later packet remains
