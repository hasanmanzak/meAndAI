...
implementation hosted check pending; `A-TRANSITION-01` remains Candidate/inactive.
...
remain Candidate/inactive, and no A completion/DoD is claimed.
ContractSlice B/C/D,
