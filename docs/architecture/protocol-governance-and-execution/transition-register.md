...
| Current A implementation boundary | Immutable predecessors; A `19/20`, `32/32`; Resource hosted green; V1/V2/V3 diagnostic; V4 `FrozenDesign`/inactive, D/RT `0/0/0`, exact-head hosted design gate pending; parent scenario held. |
...
| Transition state | Accepted architecture; A `19/20`, `32/32`; V1/V2/V3 diagnostic; V4 `FrozenDesign`/inactive, D/RT `0/0/0`, exact-head hosted design gate pending. B/C/D, activation, WIP, completion/DoD held. |
