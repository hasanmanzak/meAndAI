...
| Current slice boundary | ContractSlice A is merged/exact-main green; B surface, codec, three wires, B-RESOURCE, B-CACHE, B-ADMISSION, and B-SEALED-CONTEXT are exact-head hosted green. Resource R=0006, cache R=0007, admission R=0011, and sealed-context R=0012 are accepted/immutable. Admission R=0008/R=0009/R=0010 and codec-derivation R=0013 are immutable diagnostics/no-success. B remains `10/11`, A+B `42/43`; corrected R=0014 is `FrozenDesign`/inactive pending this synchronized diagnostic/design head's hosted gate; B-CONVERGE and the parent scenario remain held. |
...
| Transition state | Accepted architecture; A is immutable merged history; B surface, codec, three wires, B-RESOURCE, B-CACHE, B-ADMISSION, and B-SEALED-CONTEXT are hosted green. Cache R=0007, admission R=0011, and sealed-context R=0012 are accepted; admission R=0008/R=0009/R=0010 plus codec-derivation R=0013 are immutable diagnostics/no-success. Corrected R=0014 is `FrozenDesign`/inactive pending this synchronized diagnostic/design head's hosted gate. B-CONVERGE, C/D, final activation, WIP, completion/DoD remain held. |
