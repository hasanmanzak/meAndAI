...
| Current authority | ContractSlice A and B are merged/exact-main green, with B `11/11` and A+B `43/43`. The C Activation cohort is `ExactHeadHostedGreen`; C is `5/11` and current A+B+C is `48/48`. Applicability R=0006 is diagnostic/no-success; corrected R=0007 is frozen/inactive pending corrected-design hosted green. D, activation, merge/release/publication remain held. |
