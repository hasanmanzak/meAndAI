...
| Current authority | ContractSlice A-D and final [TEST-0210](../../features/FEAT-0065-shared-executable-conformance-runtime/test-cases.md#test-0210) activation are merged/exact-main hosted green. [SUBF-0144](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0144) has seven `ReviewedLocalGreen` packets and is merged at exact main [`a291556b2fa3c6fbaac7fa564ed35baadb5e9626`](https://github.com/hasanmanzak/meAndAI/commit/a291556b2fa3c6fbaac7fa564ed35baadb5e9626); exact-main hosted-green/DoD remain unclaimed. [SUBF-0154](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0154) retains its corrected consolidated `AcceptedFrozenDesign`; `REPORT-SEALING-01` is `ReviewedLocalGreen`, its sole R is immutable, and its local route is green while [TEST-0222](../../features/FEAT-0065-shared-executable-conformance-runtime/test-cases.md#test-0222) remains Planned. Cohort-2/3 remain inactive with P/R `NotApplicable`; push, hosted validation, completion, release, and publication remain separate and unclaimed. |
