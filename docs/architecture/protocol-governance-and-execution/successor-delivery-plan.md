...
checkpoint `f64860ef...` / tree `4ca02623...` on draft PR #174. Its remote-equal
record-sync successor is the next-packet predecessor; no successor A increment
is active. WIP extraction,
