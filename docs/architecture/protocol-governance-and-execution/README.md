...
| Status | Accepted architecture; [SUBF-0143](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0143) Gate 2 accepted. ContractSlice A is merged/exact-main green; B surface, codec activation, repository-tree, and governed-text are exact-head hosted green. Repository-target R=0004 is an immutable oracle-rejected diagnostic with no canonical red; corrected R=0005 is `FrozenDesign`/inactive pending its exact correction-design-head hosted gate. B `5/11`, cumulative A+B `37/43`. Parent scenario `Planned`; no activation/DoD. |
...
| Current slice boundary | ContractSlice A is immutable merged history. ContractSlice B structural surface, codec activation, repository-tree, and governed-text are hosted green at B `5/11`, A+B `37/43`; repository-target R=0004 is diagnostic-only and corrected R=0005 is frozen/inactive pending its exact correction-design-head hosted gate, while later B packets, C/D, and final activation remain held. |
