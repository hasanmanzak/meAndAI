...
| Current slice boundary | ContractSlice A-D and final [TEST-0210](../../features/FEAT-0065-shared-executable-conformance-runtime/test-cases.md#test-0210) activation are immutable merged/exact-main-hosted-green history. [SUBF-0144](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0144) is `AcceptedFrozenDesign`; its surface/framing packet is `ReviewedLocalGreen`, while later packets, [TEST-0211](../../features/FEAT-0065-shared-executable-conformance-runtime/test-cases.md#test-0211) activation, and feature DoD remain held. |
...
| Current authority | Historical A-D and final-activation records own the closed predecessor. [SUBF-0144](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0144) is `AcceptedFrozenDesign`; its ordered implementation authority is active and the surface/framing predecessor is `ReviewedLocalGreen`. Feature DoD, WIP extraction, consumer mutation, merge, release, publication, authority transfer, and PowerShell retirement remain held. |
