...
| Status | Accepted architecture; [SUBF-0143](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0143) Gate 2 accepted. ContractSlice A is merged/exact-main green; `B-SURFACE-01` is `ReviewedLocalGreen` with B `2/11` and cumulative A+B `34/43`, hosted pending. Parent scenario `Planned`; no activation/DoD. |
...
| Current slice boundary | ContractSlice A is immutable merged history. ContractSlice B structural surface is local green; `B-CODEC-ACTIVATION-01`, C/D, and final activation remain inactive/held. |
