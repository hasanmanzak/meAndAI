...
| Status | Accepted architecture; [SUBF-0143](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0143) Gate 2 accepted. ContractSlice A is merged/exact-main green; B surface, codec, three wire packets, B-RESOURCE, and B-CACHE are exact-head hosted green. Resource R=0006, cache R=0007, and admission R=0011 are accepted/immutable. B is `9/11`, cumulative A+B `41/43`; admission R=0008/R=0009/R=0010 are immutable diagnostics/no-success, and B-ADMISSION is `ReviewedLocalGreen` with its implementation head hosted pending. Later packets and the parent scenario remain inactive; no activation/DoD is claimed. |
...
| Current slice boundary | ContractSlice A is immutable merged history. ContractSlice B surface, codec, three wires, B-RESOURCE, and B-CACHE are hosted green; cache R=0007 and admission R=0011 are accepted. B is `9/11`, A+B `41/43`; admission R=0008/R=0009/R=0010 are immutable diagnostics/no-success, and B-ADMISSION is `ReviewedLocalGreen` with its implementation head hosted pending, while later B, C/D, and final activation remain held. |
