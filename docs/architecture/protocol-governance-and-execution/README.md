...
| Current slice boundary | ContractSlice A-D and final [TEST-0210](../../features/FEAT-0065-shared-executable-conformance-runtime/test-cases.md#test-0210) activation are immutable merged/exact-main-hosted-green history. [SUBF-0144](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0144) is `AcceptedFrozenDesign`; its first six ordered packets through `SELF-CONSUMPTION-01` are `ReviewedLocalGreen`; `PROTECTED-POLICY-CONVERGE-01` is next, permitted, and inactive; [TEST-0211](../../features/FEAT-0065-shared-executable-conformance-runtime/test-cases.md#test-0211) remains Planned and feature DoD remains held. |
...
| Current authority | Historical A-D and final-activation records own the closed predecessor. The accepted [SUBF-0144](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0144) design activates its ordered implementation; the first six packets through self-consumption are `ReviewedLocalGreen`; and the immutable input-custody, issued-closure/API-oracle, and canonical outcome-entry projection corrections are exact-head hosted green. `PROTECTED-POLICY-CONVERGE-01` is next, permitted, and inactive after preserved canonical R0004/R0005. Feature DoD, WIP extraction, consumer mutation, merge, release, publication, authority transfer, and PowerShell retirement remain held. |
