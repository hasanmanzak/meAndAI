...
| Status | Accepted architecture; [SUBF-0143](../../features/FEAT-0065-shared-executable-conformance-runtime/README.md#subf-0143) Gate 2 accepted. ContractSlice A is merged/exact-main green; B surface, codec, three wire packets, and B-RESOURCE are exact-head hosted green. Resource R=0006 is accepted/immutable. B is `7/11`, cumulative A+B `39/43`; B-CACHE is `FrozenDesign`/inactive pending this exact design head's hosted gate. Later packets and the parent scenario remain inactive; no activation/DoD is claimed. |
...
| Current slice boundary | ContractSlice A is immutable merged history. ContractSlice B surface, codec, three wires, and B-RESOURCE are hosted green. B is `7/11`, A+B `39/43`; B-CACHE is `FrozenDesign`/inactive pending this exact design head's hosted gate. Later B, C/D, and final activation remain held. |
