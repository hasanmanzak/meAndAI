    ...
    Authorities = @(
        @{
            ...
            TestIds = @(
                ...
                'TEST-0132', 'TEST-0173', 'TEST-0174', 'TEST-0175',
                'TEST-0177'
            )
        }
        @{
        ...
        @{
            Evidence = 'DotNetTestProject'
            Owner = 'tests/dotnet/MeAndAI.Operations.Packaging.Tests/MeAndAI.Operations.Packaging.Tests.csproj'
            TestIds = @('TEST-0193')
        }
        @{
        ...
        @{
            Evidence = 'PlannedDocumentation'
            Owner = 'docs/features/FEAT-0064-governance-coverage-equivalence/test-cases.md'
            TestIds = @('TEST-0196')
        }
        @{
            Evidence = 'PlannedDocumentation'
