...
Stable release, proposal, path, workflow-run, supersession, and repository
evidence invariants for v0.8.0 are tracked by
...
[GitHub issue #34](https://github.com/hasanmanzak/meAndAI/issues/34).
