...
- `A-SELECTOR-01` is packet-local `ReviewedLocalGreen` at the [selector handoff](2026-08-03-feat-0065-subf-0143-contractslice-a-selector-freeze.md), with synchronized green commit/push/exact-head hosted validation pending. `A-ADMISSION-01` and every later packet remain Candidate/inactive; no downstream implementation may activate before the selector packet is exact-head hosted green.
