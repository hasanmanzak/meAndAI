...
- `A-FINDING-01` is packet-local `ReviewedLocalGreen` on the separate [finding declaration handoff](2026-08-02-feat-0065-subf-0143-contractslice-a-finding-freeze.md); `A-SELECTOR-01` and every later packet remain Candidate/inactive until the finding packet is synchronized, committed, pushed, and exact-head hosted green. Projector/DAG, selector, admission, profile/predecessor/transition, lifecycle/resource, final Scenario/status/owner/workflow/[TEST-0146](../../../docs/features/FEAT-0035-test-runtime-efficiency/test-cases.md#test-0146), B/C/D, merge, release, publication, and consumer mutation remain held.
