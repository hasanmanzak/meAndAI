...
| State | Design, Activation, Applicability, and Evaluation design cohorts `ExactHeadHostedGreen`; R=0006/R=0008/R=0009/R=0010/R=0012/R=0013 diagnostic/no-success; R=0007/R=0011/R=0014 accepted/immutable; Evaluation Plan `ReviewedLocalGreen` in an unpushed cohort, Evaluation Advance next/`FrozenDesign` |
...
| Progress | C `8/11`; current A+B+C `51/51`; final A+B+C target `54/54`; Domain `98/98` |
