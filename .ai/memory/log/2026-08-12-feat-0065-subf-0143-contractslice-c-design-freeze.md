...
| State | Design, Activation, and Applicability cohorts `ExactHeadHostedGreen`; R=0006/R=0008/R=0009/R=0010/R=0012/R=0013 diagnostic/no-success; R=0007/R=0011/R=0014/R=0015 accepted/immutable; Evaluation Plan and Advance are separate packet-local `ReviewedLocalGreen` commits in one unpushed cohort; Results/closure held pending Evaluation cohort exact-head hosted green |
