...
- `D-REAL-PRODUCER-INFRASTRUCTURE-01` is immutable `ExactHeadHostedGreen`. `D-RULE-0001-01` and `D-RULE-0002-01` are separate `ReviewedLocalGreen` packets; their first-rules cohort awaits one push and exact-head hosted validation. RULE-0003 remains inactive. The parent scenario remains Planned; final activation, runtime-efficiency scenario, merge, release, publication, and DoD remain held.
