...
- Tests: [TEST-0115](../../../docs/features/FEAT-0024-v0101-parallel-windows-validation/test-cases.md) and [TEST-0116](../../../docs/features/FEAT-0024-v0101-parallel-windows-validation/test-cases.md)
...
- Focused Windows PowerShell 5.1 shards passed in 11.5, 57.8, 246.8, and 39.7
  seconds. [FIND-0157](../../../docs/features/FEAT-0024-v0101-parallel-windows-validation/README.md) corrected the release-archive helper's script-scope
...
- The Windows base profile passed in 162.3 seconds, and the single final local
  full suite passed every canonical scenario through [TEST-0116](../../../docs/features/FEAT-0024-v0101-parallel-windows-validation/test-cases.md) in 507.6
  seconds.
